...
document.getElementById('searchBar').addEventListener('input', function() {
    ...
    shopItems.forEach(item => {
        const name = item.getAttribute('data-name').toLowerCase();  // Convert shop name to lowercase
        const location = item.getAttribute('data-location').toLowerCase();  // Convert location to lowercase

        // Check if either name or location matches the search query
